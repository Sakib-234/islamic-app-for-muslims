...
PrayerTimeApiModel prayerTimeApiModelFromJson(String str) =>
    PrayerTimeApiModel.fromJson(json.decode(str));

String prayerTimeApiModelToJson(PrayerTimeApiModel data) =>
    json.encode(data.toJson());

class PrayerTimeApiModel {
  int code;
  String status;
  Data data;
  ...
  factory PrayerTimeApiModel.fromJson(Map<String, dynamic> json) =>
      PrayerTimeApiModel(
        code: json["code"],
        status: json["status"],
